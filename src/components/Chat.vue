...
const sendMessage = () => {
    ...
    socket.emit('s1', { message: msg, to: 'vaishali', from: 'admin' })
    message = ''
}
    ...
    <main class="w-screen h-screen bg-primary-very-light text-zinc-50 font-sans antialiased flex">
        <nav class="bg-slate-700 w-1/4 h-screen drop-shadow-xl">
            ...
            <section id="user" class="p-5 grid grid-cols-8">
                ...
                <div class="col-span-6">
                    <p class="font-semibold">Tanishq Joshi</p>
            ...
            <section id="w-full h-full">
                <div class="mt-10 px-5">
                    <div class="flex items-center">
                        ...
                        <router-link to="/chat/vaishali"  target="_blank" >
                            <p class="self-center basis-3/4">Vaishali</p>
                        </router-link>
                    </div>
        ...
        <section id="chat-window" class="w-3/4 float-right">
            ...
            <section id="user" class="p-5 flex w-full shadow-lg">
                <div class="rounded-full w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-500 mr-2"></div>
                <div class="col-span-6">
                    <p class="font-semibold text-zinc-500">Tanishq Joshi</p>
